  ...
  return (
    <div className="h-full flex flex-col items-center justify-center gap-6 text-center">
      <div className="p-6 rounded-3xl bg-white/[0.02] border border-white/10 shadow-2xl">
        <FolderTree size={48} className="text-white/20" />
      </div>
      <div className="space-y-2">
        <h1 className="text-2xl font-black text-white uppercase tracking-[0.2em] italic">Workspace Hub</h1>
        <p className="text-sm text-muted-foreground font-medium max-w-md">
          Explorador de arquitectura y gestión de archivos persistentes. 
          Auditoría de código generado por el Software Chief.
        </p>
      </div>
